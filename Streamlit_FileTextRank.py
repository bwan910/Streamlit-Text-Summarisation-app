...
def generate_summary():
    ...
    number = st.number_input('Type the summarised sentence number you need:  (If is set to 0, then will be default to 5 sentences)', step=1,min_value=0)
    ...
    # function for generating summary for Text Documents
